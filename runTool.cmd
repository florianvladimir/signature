...
rem *****************************************************************************
rem  2019 by Swiss Post, Information Technology Services
rem
rem  Version 7.0.2
rem *****************************************************************************
...
set project.shortname=lad
set maven.version=3.6.3
set ant.version=1.7.0
set java.version=jdk11.0.2_9
set eclipse.version=4.2.2-2.0.0
set eclipse-workspace.version=4.2.2-2.0.0
set tomcat.version=8.0.18-x64
set node.version=v12.18.2-x64
set spark.version=2.3.1-bin-hadoop2.7
set hadoop.version=2.7.1
set scala.version=2.11.12

set maven.optional=true
set eclipse.optional=true
set eclipse-workspace.optional=true
set java.optional=true
...
set JREPO_HOME=http://artifactory.pnet.ch/artifactory/generic-tools-local/ch/post/it/tools
...
echo.
echo     - JREPO_HOME (default: https://artifactory.tools.pnet.ch/artifactory/generic-tools-local/ch/post/it/tools)
echo.
echo
goto end
